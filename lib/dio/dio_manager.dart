  ...
  BaseResponse _createErrorEntity(DioException error) {
    switch (error.type) {
      case DioExceptionType.cancel:
        return BaseResponse.fromJson({BaseResponse.msgCon: '取消请求'});
      case DioExceptionType.connectionTimeout:
        return BaseResponse.fromJson({BaseResponse.msgCon: '连接超时'});
      case DioExceptionType.sendTimeout:
        return BaseResponse.fromJson({BaseResponse.msgCon: '发送超时'});
      case DioExceptionType.receiveTimeout:
        return BaseResponse.fromJson({BaseResponse.msgCon: '响应超时'});
      case DioExceptionType.connectionError:
        return BaseResponse.fromJson({BaseResponse.msgCon: '连接错误'});
      ...
      default:
        return BaseResponse.fromJson({
          BaseResponse.msgCon: error.message,
        });
    }
  }
}
